...
spark-submit \
        ...
        safetab-h.py execute resources/toy_dataset/input_dir_puredp resources/toy_dataset \
        example_output/safetab_h --log example_output/safetab_h/sample.log --validate-private-output
