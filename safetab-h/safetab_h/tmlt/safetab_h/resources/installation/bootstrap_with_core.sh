...
sudo $PYTHON -m pip install boto3==1.28.1
sudo $PYTHON -m pip install botocore==1.31.1
sudo $PYTHON -m pip install colorama==0.4.6
sudo $PYTHON -m pip install exceptiongroup==1.1.2
sudo $PYTHON -m pip install iniconfig==2.0.0
sudo $PYTHON -m pip install jmespath==1.0.1
sudo $PYTHON -m pip install mpmath==1.3.0
sudo $PYTHON -m pip install nose==1.3.7
...
sudo $PYTHON -m pip install s3transfer==0.6.1
...
sudo $PYTHON -m pip install tomli==1.2.3
...
sudo -m pip install tmlt-core==0.12.0
