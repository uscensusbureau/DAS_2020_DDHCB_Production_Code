#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# This file is a modified version of the auto-generated validator
# It runs validation on QRACE values to ensure they fit parameters
...
class CEF20_UNIT_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_RTYPE(fields[0]) == False: return False
        if self.is_valid_MAFID(fields[1]) == False: return False
        if self.is_valid_BCUSTATEFP(fields[2]) == False: return False
        if self.is_valid_VERSION(fields[3]) == False: return False
        if self.is_valid_FINAL_POP(fields[4]) == False: return False
        if self.is_valid_HHLDRAGE(fields[5]) == False: return False
        if self.is_valid_HHSPAN(fields[6]) == False: return False
        if self.is_valid_HHLDRACE(fields[7]) == False: return False
        if self.is_valid_HHRACE(fields[8]) == False: return False
        if self.is_valid_TEN(fields[9]) == False: return False
        if self.is_valid_TEN_A(fields[10]) == False: return False
        if self.is_valid_TEN_R(fields[11]) == False: return False
        if self.is_valid_VACS(fields[12]) == False: return False
        if self.is_valid_QGQTYP(fields[13]) == False: return False
        if self.is_valid_GQSEX(fields[14]) == False: return False
        if self.is_valid_OIDTB(fields[15]) == False: return False
        if self.is_valid_HHT(fields[16]) == False: return False
        if self.is_valid_HHT2(fields[17]) == False: return False
        if self.is_valid_CPLT(fields[18]) == False: return False
        if self.is_valid_UPART(fields[19]) == False: return False
        if self.is_valid_MULTG(fields[20]) == False: return False
        if self.is_valid_PAOC(fields[21]) == False: return False
        if self.is_valid_P18(fields[22]) == False: return False
        if self.is_valid_P60(fields[23]) == False: return False
        if self.is_valid_P65(fields[24]) == False: return False
        if self.is_valid_P75(fields[25]) == False: return False
...
class CEF20_PER_validator:
    ...
    def is_valid_QSPAN(self,x):
        ...
        try:
            ...
            return False
        return (1000 <= x <= 8999) or (x == 9000) or (x == 9100) or (x == 9200) or (x == 9500) or (x == 9900) or (x == 9950)
    @classmethod
    ...
    def is_valid_QRACE1(self,x):
        ...
        try:
            ...
            return False
        return (1000 <= x <= 8999) or (x == 9000) or (x == 9500) or (x == 9900)
    @classmethod
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_RTYPE(fields[0]) == False: return False
        if self.is_valid_MAFID(fields[1]) == False: return False
        if self.is_valid_CUF_PNC(fields[2]) == False: return False
        if self.is_valid_BCUSTATEFP(fields[3]) == False: return False
        if self.is_valid_VERSION(fields[4]) == False: return False
        if self.is_valid_QSEX(fields[5]) == False: return False
        if self.is_valid_QAGE(fields[6]) == False: return False
        if self.is_valid_QDB(fields[7]) == False: return False
        if self.is_valid_QDOB_MONTH(fields[8]) == False: return False
        if self.is_valid_QDOB_DAY(fields[9]) == False: return False
        if self.is_valid_QDOB_YEAR(fields[10]) == False: return False
        if self.is_valid_QSPAN(fields[11]) == False: return False
        if self.is_valid_QSPANX(fields[12]) == False: return False
        if self.is_valid_CENHISP(fields[13]) == False: return False
        if self.is_valid_QRACE1(fields[14]) == False: return False
        if self.is_valid_QRACE2(fields[15]) == False: return False
        if self.is_valid_QRACE3(fields[16]) == False: return False
        if self.is_valid_QRACE4(fields[17]) == False: return False
        if self.is_valid_QRACE5(fields[18]) == False: return False
        if self.is_valid_QRACE6(fields[19]) == False: return False
        if self.is_valid_QRACE7(fields[20]) == False: return False
        if self.is_valid_QRACE8(fields[21]) == False: return False
        if self.is_valid_QRACEX(fields[22]) == False: return False
        if self.is_valid_CENRACE(fields[23]) == False: return False
        if self.is_valid_RACE2010(fields[24]) == False: return False
        if self.is_valid_RELSHIP(fields[25]) == False: return False
        if self.is_valid_QGQTYP(fields[26]) == False: return False
        if self.is_valid_LIVE_ALONE(fields[27]) == False: return False
        return True
...
class CEF20_CNT_validator:
    ...
    def validate_pipe_delimited(self,x):
        ...
        if self.is_valid_BCUSTATEFP(fields[0]) == False: return False
        if self.is_valid_VERSION(fields[1]) == False: return False
        if self.is_valid_COUNT_UNIT(fields[2]) == False: return False
        if self.is_valid_COUNT_UNIT_HU(fields[3]) == False: return False
        if self.is_valid_COUNT_UNIT_GQ(fields[4]) == False: return False
        if self.is_valid_COUNT_PER(fields[5]) == False: return False
        if self.is_valid_COUNT_PER_HU(fields[6]) == False: return False
        if self.is_valid_COUNT_PER_GQ(fields[7]) == False: return False
        return True
